...
if __name__ == "__main__":
    ...
    time_loop = timeit.timeit(lambda: concat_loop(segments), number=num_iterations)  # noqa: E501
    time_join_list = timeit.timeit(
        lambda: concat_join_list(segments), number=num_iterations
    )
