...
class ShavianConverter:
    ...
    def _convert_word_impl(self, word, threshold):
        ...
        while i < len(ipa_text):
            ...
            if not match:
                ...
                unknown_count += 1
                logger.warning(
                    f"Unknown IPA character '{char}' in word '{word}' (IPA: {ipa_text})"  # noqa: E501
                )  # noqa: E501
        ...
        if total_ipa_chars > 0:
            ...
            if unknown_ratio > self.fallback_threshold:
                logger.warning(
                    f"Fallback triggered for '{word}': {unknown_count}/{total_ipa_chars} unknown ({unknown_ratio:.2f} > {self.fallback_threshold})"  # noqa: E501
                )  # noqa: E501
                return word
    ...
    def convert_sentence(self, text):
        ...
        for part in parts:
            ...
            # check if part matches our word definition using pre-compiled regex  # noqa: E501
